...
document.getElementById("btn-display-donation").onclick = () => {
    const error = document.getElementById("p-donation-error");
    errorP.innerHTML = "";
    ...
    document.getElementById("p-donation").innerHTML = 'Youve reached your goal of $5000!'.repeat(percentGoal/100);
}